...
popd
echo "   7 tests fail for undetermined reasons..."
echo "   7 tests fail for undetermined reasons..." >> $LFSLOG_PROCESS
echo "   7 tests fail for undetermined reasons..." >> $PKGLOG_ERROR
