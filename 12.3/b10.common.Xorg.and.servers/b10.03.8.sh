...
echo "b10.13.23.15.Packaging-24.2"
echo "b10.13.23.15.Packaging-24.2" >> $LFSLOG_PROCESS

time { bash b10.13.23.15.Packaging-24.2.sh ; }
...
echo "b10.13.24.32.Trove-Classifiers-2025.1.15.22"
echo "b10.13.24.32.Trove-Classifiers-2025.1.15.22" >> $LFSLOG_PROCESS

time { bash b10.13.24.32.Trove-Classifiers-2025.1.15.22.sh ; }
...
echo "b10.13.24.09.Hatchling-1.27.0"
echo "b10.13.24.09.Hatchling-1.27.0" >> $LFSLOG_PROCESS

time { bash b10.13.24.09.Hatchling-1.27.0.sh ; }
...
echo "b10.13.23.26.Pytest-8.3.4"
echo "b10.13.23.26.Pytest-8.3.4" >> $LFSLOG_PROCESS

time { bash b10.13.23.26.Pytest-8.3.4.sh ; }
