...
echo "b10.04.16.Nettle-3.10.1"
echo "b10.04.16.Nettle-3.10.1" >> $LFSLOG_PROCESS

time { bash b10.04.16.Nettle-3.10.1.sh ; }
...
echo "b10.09.70.libuv-1.50.0"
echo "b10.09.70.libuv-1.50.0" >> $LFSLOG_PROCESS

time { bash b10.09.70.libuv-1.50.0.sh ; }
...
echo "b10.17.02.cURL-8.12.1"
echo "b10.17.02.cURL-8.12.1" >> $LFSLOG_PROCESS

time { bash b10.17.02.cURL-8.12.1.sh ; }
