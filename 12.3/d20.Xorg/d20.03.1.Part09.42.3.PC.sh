...
echo "d20.42.21.intel-vaapi-driver-2.4.1"
echo "d20.42.21.intel-vaapi-driver-2.4.1" >> $LFSLOG_PROCESS

time { bash d20.42.21.intel-vaapi-driver-2.4.1.sh ; }
