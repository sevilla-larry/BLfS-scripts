...
#
#   read NOTES at: https://www.linuxfromscratch.org/blfs/view/12.4/general/elogind.html
#
...
#        >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR    BLfS 12.2
