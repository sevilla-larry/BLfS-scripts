...
tar -xvf ../llvm-cmake-20.1.8.src.tar.xz        \
    >> $PKGLOG_TAR 2>> $PKGLOG_ERROR
tar -xvf ../llvm-third-party-20.1.8.src.tar.xz  \
    >> $PKGLOG_TAR 2>> $PKGLOG_ERROR
...
tar -xvf ../clang-20.1.8.src.tar.xz -C tools    \
    >> $PKGLOG_TAR 2>> $PKGLOG_ERROR
mv -v tools/clang-20.1.8.src tools/clang        \
    >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR

tar -xvf ../compiler-rt-20.1.8.src.tar.xz -C projects       \
    >> $PKGLOG_TAR 2>> $PKGLOG_ERROR
