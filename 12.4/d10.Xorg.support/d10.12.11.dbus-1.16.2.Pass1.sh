# d10.12.11.dbus-1.16.2.Pass1.sh
#
...
#
# Optional needed for test by: ( not implemented )
#
...
#  rm -vrf /usr/share/doc/dbus-1.16.2    >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR
#  mv -v   /usr/share/doc/dbus{,-1.16.2} >> $PKGLOG_OTHERS 2>> $PKGLOG_ERROR
#fi
...
# 
#echo "read: https://www.linuxfromscratch.org/blfs/view/12.4/general/dbus.html for other info"
