# d10.09.18.GLib-2.84.4.sh
#

#
# Dependencies Recommended:
#
#               d10.13.24.08 docutils-0.21.2
...
#
#           ??? e21.25.04    Cairo-1.18.2 (test)    (circular)
#               d10.12.11    dbus-1.16.2 (Pass1)    (tests)
#               a.08.91.36   docbook-xml-4.5
#               a.08.91.37   docbook-xsl-nons-1.79.2
#               b10.13.24.14 Mako-1.3.10
#               a.08.93.05 Git-2.50.1               (hidden)
#

#
# Required by:
#
#               d10.04.21 Polkit-126
#               d10.11.04 desktop-file-utils-0.28
#               d10.11.16 shared-mime-info-2.4
