...
echo "e10.12.01.7zip-25.01"
echo "e10.12.01.7zip-25.01" >> $LFSLOG_PROCESS

time { bash e10.12.01.7zip-25.01.sh ; }
...
if [ "$DE" -eq 3 ] || [ "$DE" -eq 4 ] || [ "$DE" -eq 5 ]; then

    echo "e10.09.30.JSON-GLib-1.10.6"
    echo "e10.09.30.JSON-GLib-1.10.6" >> $LFSLOG_PROCESS

    time { bash e10.09.30.JSON-GLib-1.10.6.sh ; }
